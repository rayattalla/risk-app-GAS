...
var SKILLS_CATALOG = [
  ...
  ['search', 'implemented',
    ...
    'Khoj (Online / SearchWeb)', "Add 'search' to skills, then AGENTS -> Setup (one-time) -> Set Web Search API Key (Serper)."],
  ['email', 'implemented',
